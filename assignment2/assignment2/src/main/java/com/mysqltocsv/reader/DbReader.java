...
import com.mysqltocsv.config.UserRowMapper;
...
public class DbReader extends JdbcCursorItemReader<User>{
    ...
    public DbReader(DataSource dataSource){
        ...
        this.setSql("SELECT gender,race,parental_level_of_education,test_preparation_course,math_score FROM user WHERE gender='male';");
